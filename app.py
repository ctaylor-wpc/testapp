...
">
  <p style="font-size: 1.05rem; margin: 0 0 6px 0;">📎 <strong>Upload Resume</strong></p>
  <p style="font-size: 0.9rem; margin: 0;">
    Option unavailable at this time. Please submit your application below.<br>
    You are welcome to bring your resume to your interview.
  </p>
</div>
""", unsafe_allow_html=True)
...
""", unsafe_allow_html=True)
        ...
        # Poll every 2 seconds — non-blocking.
        time.sleep(2)
        st.rerun()
